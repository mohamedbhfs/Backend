...
from .models import Employe,Point_vente,Formulaire,Case,Visite,Position,Repense_case,Avertissement_retard
...
class PositionSerializer(serializers.ModelSerializer):
    class Meta:
        model=Position
        fields = '__all__'
class RepenseCaseSerializer(serializers.ModelSerializer):
    class Meta:
        model=Repense_case
        fields = '__all__'
